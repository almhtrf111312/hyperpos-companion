...
const navItems: NavItem[] = [
  ...
  { icon: BookOpen, translationKey: 'nav.library' as TranslationKey, path: '/library', requiresBookstore: true, tourId: 'library', tooltipKey: 'tooltip.library' as TranslationKey },
  { icon: Wrench, translationKey: 'nav.services', path: '/services', requiresMaintenance: true, tourId: 'services', tooltipKey: 'tooltip.services' as TranslationKey },
  ...
  { icon: Package, translationKey: 'nav.warehouses', path: '/warehouses', adminOnly: true, hideInNoInventory: true, tourId: 'warehouses', tooltipKey: 'tooltip.warehouses' as TranslationKey },
  { icon: Package, translationKey: 'nav.stockTransfer', path: '/stock-transfer', adminOnly: true, hideInNoInventory: true, tourId: 'stock-transfer', tooltipKey: 'tooltip.stockTransfer' as TranslationKey },
