...
const navItems: NavItem[] = [
  ...
  { icon: FileText, translationKey: 'nav.invoices', path: '/invoices', tooltipKey: 'tooltip.invoices' as TranslationKey },
  { icon: Package, translationKey: 'nav.products', path: '/products', adminOnly: true, dynamicKey: 'products', tooltipKey: 'tooltip.products' as TranslationKey },
  { icon: Truck, translationKey: 'nav.purchases' as TranslationKey, path: '/purchases', adminOnly: true, requiresBakeryMode: true, tooltipKey: 'tooltip.purchases' as TranslationKey },
  { icon: Users, translationKey: 'nav.customersAndDebts' as TranslationKey, path: '/customers', tooltipKey: 'tooltip.customers' as TranslationKey },
  ...
  { icon: Receipt, translationKey: 'nav.expenses', path: '/expenses', tooltipKey: 'tooltip.expenses' as TranslationKey },
  ...
  { icon: BarChart3, translationKey: 'nav.reports', path: '/reports', adminOnly: true, tooltipKey: 'tooltip.reports' as TranslationKey },
