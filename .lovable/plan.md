...
- 3 أوضاع (كمية/إيراد/ربح) مع ترتيب مرئي + تصدير PDF/Excel.

### حالة التنفيذ
- 3.1 ✅ حركة منتج محدد
- 3.2 ✅ المخزون والجرد (مع جلسة جرد فعلي وتسوية تلقائية + إنشاء stock_damages للنقص)
- 3.3 ✅ قيمة العهدة (KPIs + Pie chart)
- 3.4 ✅ الأكثر مبيعاً/ربحية
