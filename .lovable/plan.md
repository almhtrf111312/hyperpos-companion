...
1. المرحلة 1 (هذه الجلسة) - إصلاحات سريعة ومحسوسة
2. المرحلة 2 (الجلسة التالية) - بناء نظام المصطلحات
3. المرحلة 3 (بعدها) - تطبيق المصطلحات على الواجهات
4. المرحلة 4 (أخيرا) - التصنيفات والحقول الافتراضية
